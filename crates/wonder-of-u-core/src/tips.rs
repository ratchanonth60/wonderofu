...
pub static BUILTIN_TIPS: &[Tip] = &[
    ...
    Tip {
        id: "ctrl-c-interrupt",
        text: "Tip: Press Ctrl+C to interrupt the assistant mid-response.",
        cooldown_sessions: 5,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    ...
    Tip {
        id: "tab-complete",
        text: "Tip: Press Tab to complete file paths and slash commands.",
        cooldown_sessions: 4,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "model-command",
        text: "Tip: Use /model to inspect or change the active provider and model.",
        cooldown_sessions: 6,
        condition: TipCondition::NewUserWarmup,
        file_history_exclusive: false,
    },
    Tip {
        ...
        text: "Tip: Use /permissions to review or change what tool actions are allowed.",
        cooldown_sessions: 6,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "review-command",
        text: "Tip: Use /review when you want a code-review pass over local changes.",
        cooldown_sessions: 7,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "skills-command",
        text: "Tip: Use /skills to inspect available project and user skills.",
        cooldown_sessions: 7,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "mcp-command",
        text: "Tip: Use /mcp to inspect configured MCP servers and tools.",
        cooldown_sessions: 7,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "init-command",
        text: "Tip: Use /init to bootstrap repository instructions for future sessions.",
        cooldown_sessions: 7,
        condition: TipCondition::NewUserWarmup,
        file_history_exclusive: false,
    },
    Tip {
        id: "copy-command",
        text: "Tip: Use /copy to copy the latest assistant response.",
        cooldown_sessions: 7,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    Tip {
        id: "resume-command",
        text: "Tip: Use /resume to continue from saved session history.",
        cooldown_sessions: 7,
        condition: TipCondition::Always,
        file_history_exclusive: false,
    },
    ...
    Tip {
        ...
        text: "Tip: You can ask the assistant to search recently opened files.",
        cooldown_sessions: 4,
